...
// 5 = Felderfordernis
  ...
  $("#cg_create_upload_add_field").click(function(){  
	...
	"<input type='text' name='upload[]' id='cb' placeholder='HTML tags allowed'  maxlength='1000' style='width:832px;'>"+
...
// 7 = Felderfordernis
  ...
  $("#cg_create_upload_add_field").click(function(){  
	...
	"<input type='text' name='upload[]' id='nf' placeholder='Placeholder'  maxlength='1000' value='' style='width:855px;'><br/>"+
...
// KOMMENTARFELD
  ...
  $("#cg_create_upload_add_field").click(function(){
	...
	"<textarea name='upload[]' id='kf' maxlength='10000' rows='10' value='' style='width:857px;' placeholder='Placeholder' ></textarea><br/>"+
	"Min. number of characters:&nbsp; <input type='text' class='Min_Char' name='upload[]' value='3' size='7' maxlength='4' value=' '><br/>"+
 ...
 // E-Mail
   ...
   $("#cg_create_upload_add_field").click(function(){
	...
	"<input type='text' name='upload[]' value='' id='ef' maxlength='100' placeholder='Placeholder'  style='width:855px;'><br/>"+
	"Required <input type='checkbox' class='necessary-check' name='upload[]' >"+
