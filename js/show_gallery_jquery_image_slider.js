		...
		//   var cg_picture_id = 1;
		   ...
		   var check = $("#cg_check").val();
			...
			if ($("#"+check+"").length > 0){
				...
				$("#cg_i_am_not_a_robot").append("<input type='checkbox' value='"+check+"' name='"+check+"' id='"+check+"' '> "+cg_language_i_am_not_a_robot+"");
...
//	alert(cg_check_voted);	
	...
	if(cg_Use_as_URL==1 && cg_ForwardToURL==1 && cg_ForwardFrom==1 && cg_img_url_entry_slider){
		...
		var urlDiv = "<div class='cg_url_slider_div' id='cg_url_slider_div"+realId+"' style='"+cg_display_info+"margin-left:"+marginLeftCGratingSlider+"px;margin-bottom:"+marginBottomUrlDiv+"px !important;background: rgba(0, 0, 0, 0.8);width:21px;height:21px;'>"+
	...
	if(cg_allow_rating==1){
			...
			var ratingBlock = "<div id='cg_plz_vote"+realId+"'>"+
			"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='1' id='cg_rate_star"+realId+"'></div>"+
			"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='2' id='cg_rate_star"+realId+"'></div>"+
			"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='3' id='cg_rate_star"+realId+"'></div>"+
			"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='4' id='cg_rate_star"+realId+"'></div>"+
			 "<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='5' id='cg_rate_star"+realId+"'></div>"+
			//"<u>"+cg_plz_vote+"...</u>
			"</div>";
			var ratingDivStyle = "color:#fff;font-size:21px;vertical-align: middle;line-height: 21px;cursor:pointer;";
			}			
			...
			var ratingDIV = "<div id='ratingCGslider"+realId+"' class='ratingCGslider' style='"+cg_display_info+"margin-left:"+marginLeftCGratingSlider+"px;margin-bottom:"+marginBottomCGratingSlider+"px !important;background: rgba(0, 0, 0, 0.8);"+ratingDivStyle+"'>"+
			...
			if(cg_check_voted==1 || cg_check_voted==2){
				...
				if(countRatingSQuantity>0){var countRatingSQuantity = "<b>&nbsp;("+countRatingSQuantity+")</b>";}
				else{var countRatingSQuantity = "<b>&nbsp;(0)</b>";}
			...
			var ratingBlock = "<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+star6url+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='6' id='cg_rate_star"+realId+"'></div>"+
			  "<div style='display:inline-block;float:left;font-size:22px;line-height:22px;color:#fff;padding:0px;margin:0px;' id='rating_cg-"+realId+"' class='rating_cg_slider"+realId+"'>"+countRatingSQuantity+"</div>";
			 //alert(ratingBlock);
			  var ratingDivStyle = "";
		//	  alert(ratingBlock);
			}
			...
			var ratingBlock = "<div id='cg_plz_vote"+realId+"'>"+
			"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star' style='float:left;cursor:pointer;width:21px;height:21px;' alt='6' id='cg_rate_star"+realId+"'></div>"+
			"</div>";
			//"<u>"+cg_plz_vote+"...</u></div>";
			var ratingDivStyle = "color:#fff;font-size:21px;vertical-align: middle;line-height: 21px;cursor:pointer;";
			}
	...
	if(cg_allow_comments==1){ 
	  	var commentsDIV = "<div id='commentsCGslider"+realId+"' class='ratingCGslider' style='"+cg_display_info+"margin-left:"+marginLeftCGcommentsSlider+"px;margin-bottom:"+marginBottomCGcommentsSlider+"px !important;background: rgba(0, 0, 0, 0.8);'>"+
...
//	else{var cg_ShowAlwaysInfoSliderDisplay = "display:none";}
   ...
   //User info zeigen, welches versteckt ist in php --- ENDE	
	...
	//  var cg_fb_like_div = $("#cg_fb_like_div"+realId+"").html();
	  ...
	  var cgFacebookDivSlider = "<div id='cgFacebookDiv"+realId+"' class='cgFacebookDiv' style='"+cg_display_info+"margin-left:"+marginLeftcgFacebookDiv+"px;"+
	  "margin-bottom:"+marginBottomcgFacebookDiv+"px !important;background: rgba(0, 0, 0, 0.8);width:"+widthFbDiv+"px;height:30px;overflow:hidden;'>"+
...
if(cg_FbLikeGallery==1){
	...
	/*$("[id*=cg_fb_like_iframe_gallery]").each(function(){
	  var fbFrameDiv = this.contentWindow;
	  fbFrameDiv.postMessage("reload","*");
	});*/
...
history.pushState("", document.title, window.location.pathname);
			...
			if(cg_allow_rating==1){	
					...
					"<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star1url+"' class='cg_slider_star1' style='float:left;"+cg_ratingStarCursorStyle+"' alt='1' id='"+cg_ratingStar+"'></div>"+
					  "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star2url+"' class='cg_slider_star2' style='float:left;"+cg_ratingStarCursorStyle+"' alt='2' id='"+cg_ratingStar+"'></div>"+
					  "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star3url+"' class='cg_slider_star3' style='float:left;"+cg_ratingStarCursorStyle+"' alt='3' id='"+cg_ratingStar+"'></div>"+
					  "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star4url+"' class='cg_slider_star4' style='float:left;"+cg_ratingStarCursorStyle+"' alt='4' id='"+cg_ratingStar+"'></div>"+
					   "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star5url+"' class='cg_slider_star5' style='float:left;"+cg_ratingStarCursorStyle+"' alt='5' id='"+cg_ratingStar+"'></div>"+
					  "<div style='display: inline; float: left; font-size: 18px; line-height: 18px; height: 18px; color: rgb(255, 255, 255); font-weight: bold;' id='rating_cg-' class='rating_cg'><b>&nbsp;("+countRatingQuantity+")</b></div></div>";
					...
					'<div style="display: inline; float: left; font-size: 16px; line-height: 16px; height: 16px; color: rgb(255, 255, 255); font-weight: bold;cursor:pointer;" class="cg_hide_until_vote_rate'+r+'">'+
					"<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star1' style='float:left;"+cg_ratingStarCursorStyle+"'  alt='1' id='"+cg_ratingStar+"'></div>"+
					 "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star2' style='float:left;"+cg_ratingStarCursorStyle+"'  alt='2' id='"+cg_ratingStar+"'></div>"+
					"<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star3' style='float:left;"+cg_ratingStarCursorStyle+"''  alt='3' id='"+cg_ratingStar+"'></div>"+
					"<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star4' style='float:left;"+cg_ratingStarCursorStyle+"'  alt='4' id='"+cg_ratingStar+"'></div>"+
					 "<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+starOffUrl+"' class='cg_slider_star5' style='float:left;"+cg_ratingStarCursorStyle+"'  alt='5' id='"+cg_ratingStar+"'></div></div>"+
					//<u>'+cg_plz_vote+'...</u>
					'</div>';
					}
			...
			if(cg_allow_rating==2){
					...
					var ratingBlock = '<div class="cg_gallery_rating_div_child" id="cg_gallery_rating_div_child'+realId+'"><input type="hidden" class="cg_check_voted" id="cg_check_voted'+realId+'" value="1">'+
					"<div style='display:inline;float:left;width:18px;height:18px;vertical-align: middle;'><img src='"+star6url+"' class='cg_slider_star1' style='float:left;"+cg_ratingStarCursorStyle+"' alt='6' id='"+cg_ratingStar+"'></div>"+
					  "<div style='display: inline; float: left; font-size: 18px; line-height: 18px; height: 18px; color: rgb(255, 255, 255); font-weight: bold;' id='rating_cg-' class='rating_cg'><b>&nbsp;("+countRatingSQuantity+")</b></div></div>";
					...
					//	alert(cg_vote_in_gallery);
							...
							//alert(cg_ratingStar);
						var ratingBlock = '<div class="cg_gallery_rating_div_child" id="cg_gallery_rating_div_child'+realId+'"><input type="hidden" class="cg_check_voted" id="cg_check_voted'+realId+'" value="0">'+
						'<div style="display: inline; float: left; font-size: 16px; line-height: 16px; height: 16px !important; color: rgb(255, 255, 255); font-weight: bold;cursor:pointer;" class="cg_hide_until_vote_rate'+r+'">'+
						"<div style='display:inline-block;float:left;vertical-align: middle;'><img src='"+starOffUrlGallery+"' class='cg_slider_star' style='float:left;cursor:pointer;' alt='6' id='"+cg_ratingStar+"'></div>";
						//"<u>'+cg_plz_vote+'...</u>"+
						"</div></div>";
					}
