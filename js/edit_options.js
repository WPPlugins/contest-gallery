jQuery(document).ready(function($){
	...
	$("#insert-media-button").css('display','none');
	$(".button.thickbox").css('display','none');
	$("#ngg-media-button").css('display','none');
	$(".insert-media.add_media").css('display','none');
	$(".ngg-add-gallery").css('display','none');
	$(".wp-switch-editor.switch-tmce").css('display','none');
