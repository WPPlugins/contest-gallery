...
edithttps://www.contest-gallery.com/test-cg-1/wp-admin/network/plugins.php?action=delete-selected&checked%5B0%5D=contest-gallery%2Findex.php&plugin_status=all&paged=1&s&_wpnonce=cd4d21a904_options2.js
...
function frontend_gallery($atts){
	...
	wp_enqueue_script( 'cg_check_back_button_click', plugins_url( '/js/cg_check_back_button_click.js', __FILE__ ), array('jquery'), '5.20.4');
	
		wp_enqueue_script( 'cg_rate', plugins_url( '/js/cg_rate.js', __FILE__ ), array('jquery'), '5.20.4' );
	...
	wp_localize_script( 'cg_rate', 'post_cg_rate_wordpress_ajax_script_function_name', array(
		...
		wp_enqueue_script( 'cg_comment', plugins_url( '/js/cg_comment.js', __FILE__ ), array('jquery'), '5.20.4' );
	...
	wp_localize_script( 'cg_comment', 'post_cg_comment_wordpress_ajax_script_function_name', array(
		...
		wp_enqueue_script( 'cg_set_comment_slider', plugins_url( '/js/cg_set_comment_slider.js', __FILE__ ), array('jquery'), '5.20.4' );
	...
	wp_enqueue_script( 'cg_show_comments_slider', plugins_url( '/js/cg_show_comments_slider.js', __FILE__ ), array('jquery'), '5.20.4' );
	...
	wp_enqueue_style( 'cg_frontend_single_image_style', plugins_url('/css/cg_frontend_single_image_style.css', __FILE__), false, '5.20.4' );
	wp_enqueue_style( 'cg_contest_style',  plugins_url('css/style.css', __FILE__), false, '5.20.4' );
		

	wp_enqueue_script( 'show_gallery_jquery', plugins_url( '/js/show_gallery_jquery.js', __FILE__ ), array('jquery'), '5.20.4');
	wp_enqueue_script( 'show_gallery_jquery_image_slider', plugins_url( '/js/show_gallery_jquery_image_slider.js', __FILE__ ), array('jquery'), '5.20.4' );
	wp_enqueue_script( 'show_image_jquery', plugins_url( '/js/show_image_jquery.js', __FILE__ ), array('jquery'), '5.20.4' );
	...
	wp_enqueue_style( 'cg_form_style', plugins_url('/css/cg_form_style.css', __FILE__), false , '5.20.4' );	
	wp_enqueue_script( 'users_upload', plugins_url( '/js/users_upload.js', __FILE__ ), array('jquery'), '5.20.4' );
...
$p_cgal1ery_db_new_version = '5.125';
...
// Update DB - END
	...
	function contest_gal1ery_users_registry($atts){
		...
		wp_enqueue_style( 'cg_form_style', plugins_url('/css/cg_form_style.css', __FILE__), false , '5.20.4' );
		wp_enqueue_script( 'cg_registry', plugins_url( '/admin/users/js/users_registry.js', __FILE__ ), array('jquery'), '5.20.4' );
		...
		ob_start();
		include_once 'admin/users/frontend/users-registry.php';
...
function cg_options_tabcontent() {
       ...
       wp_enqueue_style( 'cg_options_tabcontent', plugins_url('/admin/options/cg_options_tabcontent.css', __FILE__), false , '5.20.4' );
   }
...
// ----------------------------------------------------------- Pro Version Abschnitt ----------------------------------------------------------
	...
	function contest_gal1ery_users_login($atts){
		...
		wp_enqueue_script( 'cg_login', plugins_url( '/admin/users/js/users_login.js', __FILE__ ), array('jquery'), '5.20.4' );
		...
		ob_start();
		include_once 'admin/users/frontend/users-login.php';
	...
	function remove_admin_bar_links() {
	   ...
	   if(in_array("contest_gallery_user",$current_user->roles)==true){
			...
			$args = array(
				...
				'title' => "Account: $current_user->user_login",
			);
...
wp_enqueue_script( 'cg_color_picker_js', plugins_url( '/admin/options/color-picker.js', __FILE__ ), array('jquery'), '5.20.4' );
wp_enqueue_script( 'cg_options_tabcontent_js', plugins_url( '/admin/options/cg_options_tabcontent.js', __FILE__ ), array('jquery'), '5.20.4' );
wp_enqueue_script( 'edit_options', plugins_url( '/js/edit_options.js', __FILE__ ), array('jquery'), '5.20.4' );
wp_enqueue_script( 'jquery-ui-sortable' );
wp_enqueue_script( 'jquery-ui-datepicker' );
wp_register_style( 'contest-style-css', plugins_url('admin/options/datepicker.css', __FILE__), false, '5.20.4' );
wp_enqueue_style( 'contest-style-css', plugins_url('admin/options/datepicker.css', __FILE__), false, '5.20.4' );
wp_register_style( 'color-picker-css', plugins_url('admin/options/color-picker.css', __FILE__), false, '5.20.4' );
wp_enqueue_style( 'color-picker-css', plugins_url('admin/options/color-picker.css', __FILE__), false, '5.20.4' );
...
wp_enqueue_script( 'create_upload', plugins_url( '/js/create_upload.js', __FILE__ ), array('jquery'), '5.20.4' );
wp_enqueue_script( 'jquery-ui-sortable' );
...
wp_enqueue_script( 'create_user_form', plugins_url( '/admin/users/js/create_user_form.js', __FILE__ ), array('jquery'), '5.20.4' );
...
wp_enqueue_script( 'define_output', plugins_url( '/js/define_output.js', __FILE__ ), array('jquery'), '5.20.4' );
wp_enqueue_script( 'jquery-ui-sortable' );
...
wp_enqueue_script( 'change_text_inform_user', plugins_url( '/js/change_text_inform_user.js', __FILE__ ), array('jquery'), '5.20.4' );
...
if (@$_GET['edit_gallery'] == true) {
		...
		wp_enqueue_script( 'gallery_admin', plugins_url( '/js/gallery_admin.js', __FILE__ ), array('jquery'), '5.20.4' );
		wp_enqueue_script( 'cg_check_wp_admin_upload', plugins_url( '/js/cg_check_wp_admin_upload.js', __FILE__ ), array('jquery'), '5.20.4' );
		wp_enqueue_script( 'jquery-ui-sortable' );
		//echo "change";
		...
		elseif(@$_GET['option_id']==true AND @$_GET['create']==true AND @$_POST['cg_create']==true AND @$_GET['edit_gallery'] == true AND @$_GET['wpmadd'] != true ){
		wp_enqueue_script( 'gallery_admin', plugins_url( '/js/gallery_admin.js', __FILE__ ), array('jquery'), '5.20.4' );
		wp_enqueue_script( 'cg_check_wp_admin_upload', plugins_url( '/js/cg_check_wp_admin_upload.js', __FILE__ ), array('jquery'), '5.20.4' );
		wp_enqueue_script( 'jquery-ui-sortable' );
