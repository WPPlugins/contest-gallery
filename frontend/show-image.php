...
if ($sendOrder=='random-sort'){
	...
	if($pictureID==end($cgImageIdSArray)){
		...
		function array_set_pointer_to_key(&$cgImageIdSArray, $cgImageIdArrayKey){
		  ...
		  while(key($cgImageIdSArray) !== $cgImageIdArrayKey){ // jeden Key überprüfen
			...
			if($value->Field_Type == 'image-f'){
					...
					if($AllowRating==1 && $HideUntilVote==1){
							...
							if($countR>=1){
								...
								echo "<div style='width:160px !important;display:inline;float:left;vertical-align:bottom;' id='cg_div_rate_stars_image'>";
								  ...
								  echo "<div style='display:inline-block;float:left;width:21px;height:21px;vertical-align: middle;'><img src='$star4img' class='$star4' style='float:left;cursor:pointer;' alt='4' id='cg_rate_star4'></div>";
								  echo "<div style='display:inline-block;float:left;width:21px;height:21px;vertical-align: middle;'><img src='$star5img' class='$star5' style='float:left;cursor:pointer;' alt='5' id='cg_rate_star5'></div>";
								  echo "<div style='display:inline-block;float:left;font-size:21px;vertical-align: middle;line-height: 21px;height: 21px;color:#000;' class='rating_cg'><b>&nbsp;($countRhideUntilVote)</b></div>";	
								  echo "</div>";
					...
					if($AllowRating==2 && $HideUntilVote==1){
						...
						if($countS>=1){
							  ...
							  echo "<div style='width:160px !important;display:inline;float:left;vertical-align:bottom;' id='cg_div_rate_stars_image'>";
							  echo "<div style='display:inline-block;float:left;width:21px;height:21px;vertical-align: middle;'><img src='$star6img' class='$star6' style='float:left;cursor:pointer;' alt='6' id='cg_rate_star6'></div>";
							  echo "<div style='display:inline-block;float:left;font-size:21px;vertical-align: middle;line-height: 21px;height: 21px;color:#000;' class='rating_cg'><b>&nbsp;($countShideUntilVote)</b></div>";	
							  echo "</div>";
...
echo "<input type='hidden' id='cg_check' value='".wp_create_nonce("check")."'>";
