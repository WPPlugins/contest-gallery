...
if ($selectFormInput) {
	...
	foreach ($selectFormInput as $key => $value) {
		...
		echo "<input type='hidden' class='cg_actualID' name='actualID[]' value='$id' >";		
					...
					echo "<input type='text' class='Field_Name' name='Field_Name[$i]' value='$Field_Name'  size='30' maxlength='100'><br/>"; // Titel und Delete Möglichkeit die oben bestimmt wurde
