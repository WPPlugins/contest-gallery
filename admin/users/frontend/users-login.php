...
if(@$_POST['cg_login_check']){
	...
	$ForwardAfterLoginText = $wpdb->get_var("SELECT ForwardAfterLoginText FROM $tablename_pro_options WHERE GalleryID = '$GalleryID'");
	...
	if(!is_user_logged_in()){
		...
		echo "<div id='cg_user_login_div' >";
			echo "<div>";
				...
				echo "<div>";
				echo '<input type="submit" name="submit" id="cg_user_login_check" >';
				echo "</div>";
				echo '</form>';
			echo "</div>";
		echo "</div>";
