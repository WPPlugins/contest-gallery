...
echo <<<HEREDOC
    ...
    <div style="width: 937px;">
        <ul class="tabs" data-persist="true">
            <li class='cg_view'><a href="#view1"><strong>NEW!</strong> Multiple pics options</a></li>
...
HEREDOC;
		...
		//	echo '<input type="hidden" name="order[]" value="t" >';
			...
			echo "</tr>";
			echo "<td style='padding-left:20px;width:340px;'>";
			echo '<p><b>NEW!</b> Random sort (Each page load):<strong><br/>(Pagination will be deactivated.<br/>Lazy Load is possible.)</strong></p>';
			echo "</td>"; 
			echo "<td style='padding-left:0px;'>";
...
//print_r($order);
	...
	if($value=="ThumbLookOrder"){
			...
			echo "<tr><td style='padding-left:20px;width:340px;'>";
			//echo '<input type="text" hidden name="id" value="' . $id . '" method="post" >';
			echo '<p><b><u>Multiple pics thumb view</u></b></p>';
			echo "</td>";	
		...
		if($value=="RowLookOrder"){
			...
			echo '<p><u><b>Multiple pics row view:</u><br/>(Same amount of images in each row)</b></p>';
			echo "</td>";	
			echo "<td style='text-align:right;padding-right:20px;' class='cg_options_sortableDiv'>";
			echo '<p class="cg_options_order"><u>'.$i.'. Order</u></p>';
			echo "</td>";
...
HEREDOC;
		...
		echo "<tr>"; 
		echo "<td style='padding-left:20px;width:300px;'>";
		echo '<p>Allow only registered users to upload:';
...
width: 814px;
		...
		wp_editor( $ContentAdminMail, $editor_id,  $settings = array("media_buttons"=>false));
		echo "</div>";
...
HEREDOC;
	...
	echo "<br/>";		
		...
		wp_editor( $contentUserMail, $editor_id,  $settings = array("media_buttons"=>false));
		echo "</div>";
...
HEREDOC;
	...
	echo "<br/>";		
		...
		wp_editor( $TextEmailConfirmation, $editor_id, $settings = array("media_buttons"=>false));
		echo "</div>";
