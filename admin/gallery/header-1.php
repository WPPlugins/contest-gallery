...
echo "<div id='cg_wp_upload_div'></div>";
	...
	?>
	<div id="cg_adding_images_answer" style="position: absolute; margin-left: 40px; margin-top: 10px;width: 510px; background-color: white; border: 1px solid; padding: 5px; display: none;">
	Every image will be converted to five different resolutions. From 300pixel to 1920pixel.
